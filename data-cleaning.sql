...
# 2. Вычисление разницы в днях между датой регистрации пользователей и датой первого захода на платформу:
...
Количество аккаунтов, у которых первый вход был совершен позже дня регистрации = 28, это всего ~1,7% от всех целевых аккаунтов (1632). 
...
Абсолютное большинство пользователей совершали вход на платформу сразу в день регистрации - 
поэтому за точку отсчета можно взять именно дату регистрации, без дополнительного анализа поведения пользователей от даты первого входа. */
	
/* ========================================= */
	
# 3. Проверка, нет ли среди зарегистрировавшихся, но не зашедших ни разу на платформу аккаунтов таких, активность которых отмечена 
# в таблицах CodeRun, CodeSubmit, TestStart (исключение ошибок фиксации входов):
...
# 4. Определение когорт по месяцу регистрации:
